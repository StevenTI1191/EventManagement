...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #dcfce7; color: #16a34a; font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 99px; }
...
<div class="wrapper">
    <div class="header">
        ...
        <h1>Pembayaran Diverifikasi ✓</h1>
        <p>Konfirmasi Penerimaan Pembayaran</p>
    </div>
    <div class="body">
        <p class="greeting">Halo, {{ $bukti->client?->nama_client ?? 'Client' }}!</p>
        <p class="text">
            Kami dengan senang hati menginformasikan bahwa bukti pembayaran Anda untuk event berikut telah
            <strong>berhasil diverifikasi</strong> oleh tim Finance kami.
        </p>
        ...
        <div class="card">
            ...
            <div class="card-row">
                ...
                <span class="card-value"><span class="badge">Diverifikasi</span></span>
            </div>
            @if($bukti->catatan_finance)
            <div class="card-row">
                <span class="card-label">Catatan Finance</span>
                <span class="card-value">{{ $bukti->catatan_finance }}</span>
            </div>
            @endif
        </div>
        ...
        <p class="text">
            ...
            Terima kasih telah mempercayakan event Anda kepada <strong>Laksamana Muda Bersama</strong>.
        </p>
    </div>
    <div class="footer">
