...
<head>
    ...
    <style>
        ...
        .card { background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 12px; padding: 20px 24px; margin-bottom: 24px; }
        ...
        .highlight { background: #dbeafe; color: #2563eb; font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 99px; display: inline-block; }
        .catatan { background: #eff6ff; border-left: 4px solid #2563eb; border-radius: 0 8px 8px 0; padding: 12px 16px; margin-bottom: 20px; font-size: 14px; color: #1e40af; }
...
<div class="wrapper">
    <div class="header">
        ...
        <h1>Jadwal Appointment Diubah</h1>
        <p>Ada perubahan jadwal meeting Anda</p>
    </div>
    <div class="body">
        <p class="greeting">Halo, {{ $appointment->client?->nama_client ?? 'Client' }}!</p>
        <p class="text">
            Tim <strong>Laksamana Muda Bersama</strong> telah menjadwalkan ulang appointment Anda.
            Berikut jadwal baru yang telah ditetapkan:
        </p>
        ...
        <div class="card">
            ...
            <div class="card-row">
                <span class="card-label">Tanggal Baru</span>
            ...
            <div class="card-row">
                ...
                <span class="card-value"><span class="highlight">Reschedule</span></span>
            </div>
        </div>
        ...
        <p class="text">
            Mohon catat jadwal baru ini. Jika jadwal tidak sesuai, silakan hubungi tim kami
