/**
 * Detail klien beserta riwayat event & follow-up-nya.
 * Dipakai Event Marketing & Finance; Finance tanpa tombol sunting.
 */
...
export default function EMClientShow({ Layout, routes = {}, canEdit = true,  client, events, pics, kategoris, filters, followUps = [], waFollowUp }) {
    ...
    const tambahFollowUp = (e) => {
        ...
        router.post(route(routes.followUpStore, client.id), {
    ...
    const handleFilter = (key, value) => {
        ...
        setForm(updated);
        router.get(route(routes.show, client.id), updated, {
