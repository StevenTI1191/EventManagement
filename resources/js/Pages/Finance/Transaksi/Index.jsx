...
export default function FinanceTransaksiIndex({ auth, events, filters = {} }) {
    ...
    const applyFilter = (updated) => {
        ...
        router.get(route('finance.transaksi.index'), updated, { preserveState: true, replace: true });
    };
    ...
    const handleBayar = (e) => {
        e.preventDefault();
        formBayar.post(route('finance.transaksi.store'), {
            forceFormData: true,
    ...
    const handleItem = (e) => {
        e.preventDefault();
        formItem.post(route('finance.transaksi.item.store'), {
    ...
    const handleEditBayar = (e) => {
        e.preventDefault();
        formEditBayar.post(route('finance.transaksi.update', editBayar.id_transaksi), {
            forceFormData: true,
    ...
    const handleEditItem = (e) => {
        e.preventDefault();
        formEditItem.post(route('finance.transaksi.item.update', editItem.id_item), {
                        ...
                        <form onSubmit={handleItem} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="number" min="0" placeholder="0" className="w-full p-3 text-sm border border-gray-200 rounded-xl bg-gray-50"
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={() => setEditBayar(null)}>
                    <div className="bg-white rounded-[2rem] w-full max-w-md shadow-2xl p-8" onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleEditBayar} className="space-y-4">
                            <div>
                                <label className="block mb-1 text-xs font-bold text-gray-600">Nominal</label>
                                <input type="number" min="0" className="w-full p-3 text-sm border border-gray-200 rounded-xl bg-gray-50"
                                    value={formEditBayar.data.nominal} onChange={e => formEditBayar.setData('nominal', e.target.value)} />
                            </div>
                            <div>
                                <label className="block mb-1 text-xs font-bold text-gray-600">Tanggal Bayar</label>
                                <input type="date" className="w-full p-3 text-sm border border-gray-200 rounded-xl bg-gray-50"
                        ...
                        <form onSubmit={handleEditItem} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    <label className="block mb-1 text-xs font-bold text-gray-600">Harga</label>
                                    <input type="number" min="0" className="w-full p-3 text-sm border border-gray-200 rounded-xl bg-gray-50"
                                        value={formEditItem.data.harga} onChange={e => formEditItem.setData('harga', e.target.value)} />
                                </div>
                            </div>
