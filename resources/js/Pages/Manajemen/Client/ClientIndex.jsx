...
const TABS = [
    ...
    { key: 'Internal', label: 'Di-input Tim',   ket: 'Klien hasil approach & input tim internal.' },
];

export default function ClientIndex({ auth, clients, filters, sumber = 'Mandiri', jumlah = {} }) {
    ...
    const gantiTab = (key) => {
        setSearchTerm('');
        router.get(route('manajemen.client.index'), { sumber: key }, { preserveState: true, replace: true });
    };

    const debouncedSearch = useDebounced((value) => {
        router.get(route('manajemen.client.index'), { search: value, sumber }, {
    ...
    return (
        <ManajemenLayout>
            ...
            <div className="mb-5">
                ...
                <p className="mt-1 font-medium text-gray-400">{tabAktif.ket}</p>
            </div>
