...
export default function ClientShow({ auth, client, events, pics, kategoris, filters }) {
    ...
    const handleFilter = (key, value) => {
        ...
        setForm(updated);
        router.get(route('manajemen.client.show', client.id), updated, {
        ...
        <ManajemenLayout>
                ...
                >
                    ...
                    >
                        ...
                        <div className="relative h-44 overflow-hidden rounded-t-[2.5rem]">
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/60 rounded-t-[2.5rem]" />
                            <button
                                onClick={() => setSelectedEvent(null)}
                        ...
                        <div className="p-8">
                            ...
                            <p className="mb-6 text-sm font-medium text-gray-400">
                                {formatTanggal(selectedEvent.tgl_mulai_event)}{selectedEvent.jam_mulai ? ' · ' + selectedEvent.jam_mulai + (selectedEvent.jam_selesai ? ' – ' + selectedEvent.jam_selesai : '') : ''}
                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[
                                    ...
                                    { label: 'Client', value: selectedEvent.client?.nama_client || client.nama_client || '-' },
                                    ...
                                    { label: 'Technical Meeting', value: formatDatetime(selectedEvent.technical_meeting) },
                                    { label: 'Gladi Resik', value: formatDatetime(selectedEvent.gladi_resik) },
                                ].map((item, i) => (
            ...
            <div className="p-5 mb-6 bg-white border border-gray-100 shadow-sm rounded-2xl">
                <div className="grid grid-cols-2 gap-4 mb-4 md:grid-cols-4">
                    <div>
                        <label className="block mb-1 text-xs font-bold text-gray-500">Range Tanggal Awal</label>
                        <input
                            type="date"
                            value={form.tgl_awal}
                    ...
                    <div>
                        <label className="block mb-1 text-xs font-bold text-gray-500">Range Tanggal Akhir</label>
                        <input
                            type="date"
                ...
                <table className="w-full">
                    <thead>
                        <tr className="bg-[#FF2D55]">
                            ...
                            <th className="px-6 py-3 text-xs font-bold tracking-wider text-left text-white uppercase">Kontrak</th>
                        </tr>
                    </thead>
