...
export default function Edit({ auth, event, clients, pegawais }) {
    ...
    // Deal harga hanya milik acara pesanan klien; acara internal hasil Planning
    // memegang target omset, bukan deal harga.
                                ...
                                {DI_PIPELINE ? (
                                    <>
                                        ...
                                        <p className="mt-1 text-xs text-gray-400">
                                            ...
                                            bukan dari sini — lengkapi dulu detail acaranya agar bisa dinaikkan ke Negotiation/Deal.
                                        </p>
                                    </>
                                ) : (
                                    <select className="w-full p-3 border-gray-200 rounded-xl bg-gray-50"
