...
export default function Board({ kolom, canEdit }) {
    return (
        <PipelineBoard
            ...
            kolom={kolom}
            canEdit={canEdit}
            routes={{ updateStatus: 'manajemen.pipeline.update-status', penawaran: 'manajemen.pipeline.penawaran', batal: 'manajemen.pipeline.batal', detail: 'manajemen.event.show' }}
        />
    );
}
